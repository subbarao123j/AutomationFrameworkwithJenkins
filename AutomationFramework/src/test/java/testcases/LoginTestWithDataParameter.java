...
public class LoginTestWithDataParameter extends BaseClass {

	Login login;
	LogOut logout;
	@Parameters({"MyBrowser","AppUrl","username","password"})
	@Test
	public void loginToHRM(String browser, String appUrl,String uname, String pass) {
